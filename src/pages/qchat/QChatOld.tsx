...
import { Play, Pause, Send, Trash2Icon, Loader2 } from "lucide-react";
import { cn } from "@/lib/utils";
import ApiClient from "@/lib/api";
import CryptoJS from "crypto-js";

export default function QChatOld() {
  ...
  useEffect(() => {
    if (!name) {
      ...
      if (convName) navigate("/qchatold/" + convName);
      return;
    }
    ...
    if (!sender) {
      ...
      setStartPolling(false);
      if (codeName) navigate("/qchatold/" + name + "/" + codeName);
      return;
    }
